...
void Play_Music_Task(u8 sel,float dt)//<-----------------
{
  switch(sel)
    ...
    Tone(0,0);
		...
		case BEEP_DJ_CAL1:
			switch(dj_sel){
				case 0: Play_Music_In_Task(dj_cal_music1,0,sizeof(dj_cal_music1)/2,1,dt);break;		
				case 1: Play_Music_In_Task(dj_cal_music2,0,sizeof(dj_cal_music2)/2,1,dt);break;	
				case 2: Play_Music_In_Task(dj_cal_music3,0,sizeof(dj_cal_music3)/2,1,dt);break;	
				case 3: Play_Music_In_Task(dj_cal_music4,0,sizeof(dj_cal_music4)/2,1,dt);break;	
				case 4: Play_Music_In_Task(dj_cal_music5,0,sizeof(dj_cal_music5)/2,1,dt);break;	
				case 5: Play_Music_In_Task(dj_cal_music6,0,sizeof(dj_cal_music6)/2,1,dt);break;	
				case 6: Play_Music_In_Task(dj_cal_music7,0,sizeof(dj_cal_music7)/2,1,dt);break;	
				case 7: Play_Music_In_Task(dj_cal_music8,0,sizeof(dj_cal_music8)/2,1,dt);break;	
			}
