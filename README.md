...
条件|说明
-------------|-------------
拨码1在右  长按遥杆开关6s|提示音后校准加速度计和陀螺仪(需水平静置)
拨码1在左  长按遥杆开关6s|黄灯常亮，蜂鸣器间断响起，360°各面旋转控制器12s完成磁力计校准
拨码1和2都在左  上下竖直连续波动多次遥杆|提示音后进入舵机校准模式，舵机自动供电(需拆除腿部)，蜂鸣器以次数提示舵机编号，长扒遥杆左右改变舵机选择，上下微调舵机偏差
...
Publish Ver1.1|(1)SDK开发    
			  |(1)SDK开发<br>	(2)自适应步频<br>	(3)平稳速度S函数切换
Publish Ver1.2|(1)梯度下降融合磁场+磁场干扰判断<br> (2)KF气压计高度融合<br>    (3)KF里程计位姿融合<br>    
			  |	  
